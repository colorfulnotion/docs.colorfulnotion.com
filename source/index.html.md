...
sender_info  |  beneficiary info (if onchain identity is set)
...
destination   |  Contains info about the relayChain|
relay   |  Contains information about the destination chain|
